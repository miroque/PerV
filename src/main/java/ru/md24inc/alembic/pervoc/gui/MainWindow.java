                ...
                fj.addChoosableFileFilter(new FileFilter() {
                    ...
                    public boolean accept(File f) {
                        ...
                        int i = extension.lastIndexOf('.');
                            ...
                            if (ext != null) {
                                    if (ext.equals("pvoc"))return true;
                            } else {
                                return false;
                            }
                    ...
                    public String getDescription() {
                        return "Personal Vocabular Files";  //To change body of implemented methods use File | Settings | File Templates.
                    }
                });
...
//                int ret = fileopen.showDialog(null, "Открыть файл");
        ...
        menuFileItemQuit.addActionListener(new
ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                System.exit(0);
